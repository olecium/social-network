            ...
            <ul className={css.nav_main}>
                {
                    ...
                    ?   <>
                            ...
                            <li><span className={css.nav_main__welcome}>Hello, {props.login}</span><NavLink className={css.nav_main__link} activeClassName={css.nav_main__link_active} to="/profile">Profile</NavLink></li>
                        </>
